...
struct Colors{
    static let lightGreenBackground = Color(UIColor(#colorLiteral(red: 187/255, green: 242/255, blue: 201/255, alpha: 1)))
    static let blueGoalHeader = Color(UIColor(#colorLiteral(red: 21/255, green: 67/255, blue: 96/255, alpha: 1)))
    static let targetsListBackground = Color(UIColor(#colorLiteral(red: 0.9531050324, green: 0.9531050324, blue: 0.9531050324, alpha: 1)))
    ...
    static let buttonSignOut = Color(UIColor(#colorLiteral(red: 0.9333333333, green: 0.5411764706, blue: 0.4352941176, alpha: 0.5)))
